...
#define MAVLINK_MSG_ID_LEAF_DO_QUEUE_EXTERNAL_TRAJECTORY_LEN 2
#define MAVLINK_MSG_ID_LEAF_DO_QUEUE_EXTERNAL_TRAJECTORY_MIN_LEN 2
#define MAVLINK_MSG_ID_77023_LEN 2
#define MAVLINK_MSG_ID_77023_MIN_LEN 2

#define MAVLINK_MSG_ID_LEAF_DO_QUEUE_EXTERNAL_TRAJECTORY_CRC 153
#define MAVLINK_MSG_ID_77023_CRC 153
...
static inline uint16_t mavlink_msg_leaf_do_queue_external_trajectory_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t queue)
{
...
{
    return mavlink_msg_leaf_do_queue_external_trajectory_pack(system_id, component_id, msg, leaf_do_queue_external_trajectory->target_system, leaf_do_queue_external_trajectory->queue);
}
...
{
    return mavlink_msg_leaf_do_queue_external_trajectory_pack_chan(system_id, component_id, chan, msg, leaf_do_queue_external_trajectory->target_system, leaf_do_queue_external_trajectory->queue);
}
...
{
    return mavlink_msg_leaf_do_queue_external_trajectory_pack_status(system_id, component_id, _status, msg,  leaf_do_queue_external_trajectory->target_system, leaf_do_queue_external_trajectory->queue);
}
...
static inline void mavlink_msg_leaf_do_queue_external_trajectory_send(mavlink_channel_t chan, uint8_t target_system, uint8_t queue)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_LEAF_DO_QUEUE_EXTERNAL_TRAJECTORY_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_leaf_do_queue_external_trajectory_send(chan, leaf_do_queue_external_trajectory->target_system, leaf_do_queue_external_trajectory->queue);
#else
 ...
 */
static inline void mavlink_msg_leaf_do_queue_external_trajectory_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t queue)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
