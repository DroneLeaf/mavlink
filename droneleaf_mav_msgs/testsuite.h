...
static void mavlink_test_leaf_do_queue_external_trajectory(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_leaf_do_queue_external_trajectory_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_leaf_do_queue_external_trajectory_pack(system_id, component_id, &msg , packet1.target_system , packet1.queue );
    mavlink_msg_leaf_do_queue_external_trajectory_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_leaf_do_queue_external_trajectory_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.queue );
    mavlink_msg_leaf_do_queue_external_trajectory_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_leaf_do_queue_external_trajectory_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_leaf_do_queue_external_trajectory_send(MAVLINK_COMM_1 , packet1.target_system , packet1.queue );
    mavlink_msg_leaf_do_queue_external_trajectory_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_leaf_ack_queue_external_trajectory(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_leaf_ack_queue_external_trajectory_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_leaf_ack_queue_external_trajectory_pack(system_id, component_id, &msg , packet1.target_system , packet1.status );
    mavlink_msg_leaf_ack_queue_external_trajectory_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_leaf_ack_queue_external_trajectory_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.status );
    mavlink_msg_leaf_ack_queue_external_trajectory_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_leaf_ack_queue_external_trajectory_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_leaf_ack_queue_external_trajectory_send(MAVLINK_COMM_1 , packet1.target_system , packet1.status );
    mavlink_msg_leaf_ack_queue_external_trajectory_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_leaf_do_terminate_external_trajectory(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_leaf_do_terminate_external_trajectory_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_leaf_do_terminate_external_trajectory_pack(system_id, component_id, &msg , packet1.target_system , packet1.status );
    mavlink_msg_leaf_do_terminate_external_trajectory_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_leaf_do_terminate_external_trajectory_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.status );
    mavlink_msg_leaf_do_terminate_external_trajectory_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_leaf_do_terminate_external_trajectory_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_leaf_do_terminate_external_trajectory_send(MAVLINK_COMM_1 , packet1.target_system , packet1.status );
    mavlink_msg_leaf_do_terminate_external_trajectory_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_leaf_ack_terminate_external_trajectory(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_leaf_ack_terminate_external_trajectory_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_leaf_ack_terminate_external_trajectory_pack(system_id, component_id, &msg , packet1.target_system , packet1.status );
    mavlink_msg_leaf_ack_terminate_external_trajectory_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_leaf_ack_terminate_external_trajectory_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.status );
    mavlink_msg_leaf_ack_terminate_external_trajectory_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_leaf_ack_terminate_external_trajectory_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_leaf_ack_terminate_external_trajectory_send(MAVLINK_COMM_1 , packet1.target_system , packet1.status );
    mavlink_msg_leaf_ack_terminate_external_trajectory_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
